 ...
 * Generated at: 2020-11-12 02:36:43 UTC
...
public final class reply_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t$(\"#total\").html(\"<h3>댓글 수 : \" + data.maker.totalCount + \"</h3>\");\r\n");
      out.write("\t\t\t\tvar pg = \"\";\r\n");
      out.write("\t\t\t\tif (data.maker.prev) {\r\n");
      out.write("\t\t\t\t\tpg += \"<a href = '\" + (data.maker.startPage - 1) + \"'>←</a>\";\r\n");
      out.write("\t\t\t\t} \r\n");
      out.write("\t\t\t\tfor (var i = data.maker.startPage; i <= data.last; i++) {\r\n");
      out.write("\t\t\t\t\tif (page == i) {\r\n");
      out.write("\t\t\t\t\t\tpg += \"[<a href = '\" + i +\"' class = 'active'>\" + i + \"</a>]\";\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\tpg += \"[<a href = '\" + i +\"'>\" + i + \"</a>]\";\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tif (data.maker.next) {\r\n");
      out.write("\t\t\t\t\tpg += \"<a href = '\" + (data.maker.endPage) + \"'>→</a>\";\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t$(\"#pagination\").html(pg);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("\t$(\"#pagination .active\").on(\"click\", function(){\r\n");
      out.write("\t\talert(\"!\");\r\n");
      out.write("\t});\r\n");
